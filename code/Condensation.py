# -*- coding: utf-8 -*-
"""
Created on Mon Jul  8 13:41:12 2019
...
def make_animation(rseed=2387, 
    ...
    if case == 0:
        ...
        ptitle = 'Hyperuniformly\,\, Sampled\,\, Ellipse'
...
#    return anm
    return anim, pdir, fname, N, vname, save_movie

if "__name__" == "__main__":

    anim, pdir, fname, N, vname, save_movie = make_animation()
